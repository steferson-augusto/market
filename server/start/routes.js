...
//========================= Admin - Marks =========================
Route.get('/admin/marks', 'adminControllers/MarkController.list').middleware(['auth', 'admin'])
...
//========================= Admin - Sections =========================
Route.get('/admin/sections', 'adminControllers/SectionController.list').middleware(['auth', 'admin'])
